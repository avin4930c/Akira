        ...
        <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <Input id="make" placeholder="e.g., Yamaha" className="mt-1.5" {...form.register("make" as Path<T>)} />
                ...
                <div>
                    ...
                    <Input id="model" placeholder="e.g., MT-07" className="mt-1.5" {...form.register("model" as Path<T>)} />
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <Input id="year" type="number" placeholder="e.g., 2023" className="mt-1.5" {...form.register("year" as Path<T>, { valueAsNumber: true })} />
                ...
                <div>
                    ...
                    <Input id="registration" placeholder="e.g., ABC-1234" className="mt-1.5" {...form.register("registration" as Path<T>)} />
            ...
            <div>
                ...
                <Input id="mileage" type="number" placeholder="e.g., 12500" className="mt-1.5" {...form.register("mileage" as Path<T>, { valueAsNumber: true })} />
            ...
            <div>
                ...
                <Input id="engine" placeholder="e.g., 689cc Parallel Twin" className="mt-1.5" {...form.register("engine_type" as Path<T>)} />
            ...
            <div>
                ...
                <Input id="lastService" type="date" placeholder="Select date" className="mt-1.5" {...form.register("last_service_date" as Path<T>)} />
