...
class ChatService:
    ...
    async def process_message(self, input_message: str):
        ...
        print("The human message is", HumanMessage(content=input_message))
        response = self.llm.invoke([HumanMessage(content=input_message)])
        print("The AI response is", response)
